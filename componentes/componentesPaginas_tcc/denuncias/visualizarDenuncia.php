        ...
        <div class="containerDenunciaSelecionado">
            ...
            <div style="margin-top: 1.5rem;">
                ...
                <div class="containerOpcoesBanimento">
                    <button class="botao1 ignorarBtn" data-duracao="ignorar">Ignorar</button>
                    <button class="botao1 banBtn" data-duracao="3 Dias">3 Dias</button>
                    <button class="botao1 banBtn" data-duracao="7 Dias">7 Dias</button>
                    <button class="botao1 banBtn" data-duracao="14 Dias">14 Dias</button>                    
                </div>
            </div>
